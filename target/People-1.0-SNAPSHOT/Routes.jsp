...
<%--<form name="form1" method="post" action="selectroute">--%>
<%--    <label for="firstcity">firstcity:</label><br>--%>
<%--    <input type="text" id="firstcity" name="firstcity"><br><br>--%>
<%--    <label for="secondcity">secondcity:</label><br>--%>
<%--    <input type="text" id="secondcity" name="secondcity"><br><br>--%>
<%--    <label for="date">date:</label><br>--%>
<%--    <input type="text" id="date" name="date"><br><br>--%>
<%--    <input type="submit" value="Submit">--%>
<%--</form>--%>
<!--//        //TODO List Date First City Second City . Form Or List
//        //show routes-->
